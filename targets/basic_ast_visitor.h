...
public: // unary expressions
  ...
  virtual void do_memalloc_node(xpl::memalloc_node * const node, int lvl) = 0;
...
public: // basic nodes
  virtual void do_body_node(xpl::body_node * const node, int lvl) = 0;
...
public: // basic nodes - declaration
  virtual void do_decl_variable_node(xpl::decl_variable_node * const node, int lvl) = 0;
  virtual void do_decl_function_node(xpl::decl_function_node * const node, int lvl) = 0;
